...
class modManagers extends MODxAPI
{
    ...
    protected $groupIds = [];
    protected $mgrPermissions = [];

    /**
     * @var integer
     */
    private $rememberTime = 153792000; // 60 * 60 * 24 * 365 * 5;
    ...
    public function save($fire_events = false, $clearCache = false)
    {
        ...
        if (! $this->newDoc && $this->givenPassword) {
            $this->invokeEvent('OnManagerChangePassword', [
                'userObj'      => $this,
                'userid'       => $this->id,
                'user'         => $this->toArray(),
        ...
        // TODO
        $this->invokeEvent('OnManagerSaveUser', [
            'userObj'      => $this,
    ...
    public function delete($ids, $fire_events = false)
    {
        if ($this->edit($ids)) {
          ...
          DELETE user,attribute FROM {$this->makeTable('user_attributes')} as attribute
            ...
            $this->invokeEvent('OnManagerDeleteUser', [
                'userObj'     => $this,
                'userid'      => $this->getID(),
    ...
    public function authUser($id = 0, $fulltime = true, $cookieName = 'modx_remember_manager', $fire_events = false)
    {
        ...
        if (null !== $this->getID()) {
            ...
            $this->invokeEvent("OnManagerLogin", [
                'userObj'      => $this,
                'userid'       => $this->getID(),
                'username'     => $this->get('username'),
                'userpassword' => $this->givenPassword,
    ...
    public function testAuth($id, $password, $blocker, $fire_events = false)
    {
        ...
        if (
            ...
            $eventResult = $this->getInvokeEventResult('OnManagerAuthentication', [
                'userObj'       => $this,
                'userid'        => $tmp->getID(),
